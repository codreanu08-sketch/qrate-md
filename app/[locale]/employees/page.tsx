        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            ...
            <button 
              ...
              className="bg-blue-600 text-white py-4 rounded-2xl font-semibold disabled:opacity-70"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {employees.map(emp => {
              ...
              return (
                ...
                >
                  <button 
                    onClick={(e) => { e.stopPropagation(); deleteEmployee(emp.id, emp.name); }} 
                  ...
                  {emp.photo_url ? (
                    <img 
                      ...
                      className="w-28 h-28 rounded-full mx-auto mb-6 object-cover border-4 border-white shadow" 
                    />
                  ) : (
                  ...
                  {qrUrl && (
                    <div className="mt-6 text-center">
                      ...
                      <div className="flex gap-3 mt-4">
                        <button 
                          onClick={(e) => { e.stopPropagation(); printQR(qrUrl, emp.name); }} 
                  ...
                  <div className="mt-6">
                    <button 
                      onClick={(e) => { e.stopPropagation(); router.push(`/${locale}/employees/${emp.id}`); }} 
